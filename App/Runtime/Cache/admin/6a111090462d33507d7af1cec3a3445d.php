...
<head>
	...
	<script type="text/javascript">
		...
		window.onload = function () {
			...
			window.UEDITOR_CONFIG.serverUrl = "<?php echo U(GROUP_NAME . '/Blog/upload');?>";
			...
			<tr>
				...
				<td>
					<select name="cid">
						...
						<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["dash"]); echo ($v["name"]); ?></option><?php endforeach; endif; ?>
					</select>
				</td>
			</tr>
			<tr>
